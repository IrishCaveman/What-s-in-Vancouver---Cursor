...
Two contributors: Jason (Claude Code) and Matt (Cursor + Gemini). Same rules apply to all AI tools.

1. **Never commit directly to `main`.** Always create a feature branch first.
2. **Branch naming:** `yourname/feature-description` (e.g. `jason/showpass-api`, `matt/celebrities-scraper`)
